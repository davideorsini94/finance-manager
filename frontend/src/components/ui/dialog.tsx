  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        // Default: scroll interno quando il contenuto non ci sta (mobile,
        // tastiera aperta). `cn`/tailwind-merge fa vincere i `max-h-*` già
        // specificati dai call-site (es. TransactionForm.tsx `max-h-[90dvh]`).
